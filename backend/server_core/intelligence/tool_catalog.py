...
def build_tool_catalog() -> Dict[str, ToolSpec]:
    ...
    return {
        ...
        "breachsql": ToolSpec(
            name="breachsql",
            capabilities={"sqli_testing", "web_vulnerability"},
            target_types={TargetType.WEB_APPLICATION.value, TargetType.API_ENDPOINT.value},
            objectives={"comprehensive", "vulnerability_hunting", "api_security", "intelligence"},
            tech_affinities={TechnologyStack.PHP.value, TechnologyStack.DOTNET.value},
            noise_score=0.5,
        ...
        "phaseaccess": ToolSpec(
            name="phaseaccess",
            capabilities={"web_vulnerability", "auth_assessment"},
            target_types={TargetType.WEB_APPLICATION.value, TargetType.API_ENDPOINT.value},
            objectives={"comprehensive", "vulnerability_hunting", "api_security", "intelligence"},
            tech_affinities=set(),
            noise_score=0.3,
        ...
        "commix": ToolSpec(
            ...
            capabilities={"web_vulnerability"},
            target_types={TargetType.WEB_APPLICATION.value},
            objectives={"comprehensive", "vulnerability_hunting", "exploitation", "intelligence"},
            tech_affinities=set(),
            noise_score=0.55,
        ),
        "dotdotpwn": ToolSpec(
            name="dotdotpwn",
            capabilities={"web_vulnerability"},
            target_types={TargetType.WEB_APPLICATION.value, TargetType.NETWORK_HOST.value},
            objectives={"comprehensive", "vulnerability_hunting"},
            tech_affinities=set(),
            noise_score=0.5,
        ),
        "medusa": ToolSpec(
            name="medusa",
            capabilities={"credential_capture", "auth_assessment"},
            target_types={TargetType.NETWORK_HOST.value},
            objectives={"internal_network_ad", "comprehensive"},
            tech_affinities=set(),
            noise_score=0.6,
        ),
        "patator": ToolSpec(
        ...
        "ldapdomaindump": ToolSpec(
            name="ldapdomaindump",
            capabilities={"ad_enum", "smb_enum"},
            target_types={TargetType.NETWORK_HOST.value},
            objectives={"internal_network_ad", "comprehensive"},
            tech_affinities=set(),
            noise_score=0.3,
        ...
        "spiderfoot": ToolSpec(
            name="spiderfoot",
            capabilities={"surface", "osint_gathering"},
            target_types={TargetType.WEB_APPLICATION.value, TargetType.NETWORK_HOST.value, TargetType.UNKNOWN.value},
            objectives={"reconnaissance", "comprehensive", "intelligence"},
            tech_affinities=set(),
            noise_score=0.15,
        ),
        "parsero": ToolSpec(
            ...
            capabilities={"surface", "osint_gathering"},
            target_types={TargetType.WEB_APPLICATION.value},
            objectives={"quick", "reconnaissance", "comprehensive"},
            tech_affinities=set(),
            noise_score=0.05,
        ),
        "sublist3r": ToolSpec(
            name="sublist3r",
            capabilities={"surface", "historical_discovery"},
            target_types={TargetType.WEB_APPLICATION.value, TargetType.NETWORK_HOST.value, TargetType.API_ENDPOINT.value},
            objectives={"quick", "reconnaissance", "comprehensive", "intelligence"},
            tech_affinities=set(),
            noise_score=0.15,
        ),
        ...
        "exiftool": ToolSpec(
            name="exiftool",
            capabilities={"forensics_analysis"},
            target_types={TargetType.BINARY_FILE.value},
            objectives={"comprehensive", "intelligence", "ctf"},
            tech_affinities=set(),
            noise_score=0.05,
        ...
        "steghide": ToolSpec(
            name="steghide",
            capabilities={"steganography_analysis"},
            target_types={TargetType.BINARY_FILE.value},
            objectives={"comprehensive", "intelligence", "ctf"},
            tech_affinities=set(),
            noise_score=0.1,
