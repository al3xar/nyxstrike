...
TOOLS: Dict[str, dict] = {
    ...
    "error-handling-statistics": {
        "desc": "Get intelligent error handling system statistics and recent error patterns.",
    ...
    "test-error-recovery": {
        "desc": "Test the intelligent error recovery system with simulated failures.",
        "endpoint": "/api/error-handling/test-recovery",
        "method": "POST",
        "category": "essential",
        "params": {"tool_name": {"required": True}},
        "optional": {"error_type": "timeout", "target": "example.invalid"},
        "effectiveness": 0.70,
    },

    # ---- Python Environment ----
    "execute-python-script": {
        "desc": "Execute a Python script in a managed virtual environment on the API server.",
        "endpoint": "/api/python/execute",
        "method": "POST",
        "category": "exploitation",
        "params": {"script": {"required": True}},
        "optional": {"env_name": "default", "filename": ""},
        "effectiveness": 0.75,
    },

    # ---- File Ops & Payload Generation ----
    "create_file": {
        "desc": "Create a file with specified content on the API server.",
        "endpoint": "/api/files/create",
        "method": "POST",
        "category": "exploitation",
        "params": {"filename": {"required": True}},
        "optional": {"content": "", "binary": False},
        "effectiveness": 0.65,
    },
    "modify_file": {
        "desc": "Modify an existing file on the API server.",
        "endpoint": "/api/files/modify",
        "method": "POST",
        "category": "exploitation",
        "params": {"filename": {"required": True}},
        "optional": {"content": "", "append": False},
        "effectiveness": 0.60,
    },
    "delete_file": {
        "desc": "Delete a file or directory on the API server.",
    ...
    "list_files": {
        "desc": "List files in a directory on the API server.",
    ...
    "generate_payload": {
        "desc": "Generate large payloads for testing and exploitation.",
        "endpoint": "/api/payloads/generate",
        "method": "POST",
        "category": "exploitation",
        "params": {},
        "optional": {"payload_type": "buffer", "size": 1024, "pattern": "A", "filename": ""},
        "effectiveness": 0.60,
    },

    # ---- Wordlist Management ----
    "wordlist_get": {
        "desc": "Retrieve a specific wordlist entry by its ID.",
        "endpoint": "/api/wordlists/<wordlist_id>",
        "method": "GET",
        "category": "brute_force",
        "params": {"wordlist_id": {"required": True}},
        "optional": {},
        "effectiveness": 0.60,
    },
    "wordlist_get_all": {
        "desc": "Retrieve all wordlist entries.",
    ...
    "wordlist_get_path": {
        "desc": "Retrieve the file path for a specific wordlist by its ID.",
    ...
    "wordlist_find_best": {
        "desc": "Find the best matching wordlist based on provided criteria.",
        "endpoint": "/api/wordlists/bestmatch",
        "method": "POST",
        "category": "brute_force",
        "params": {"criteria": {"required": True}},
        "optional": {},
        "effectiveness": 0.65,
    },
    "wordlist_save": {
        "desc": "Save or update a wordlist entry in the wordlists.json file.",
        "endpoint": "/api/wordlists/<wordlist_id>",
        "method": "POST",
        "category": "brute_force",
        "params": {"wordlist_id": {"required": True}, "wordlist_info": {"required": True}},
        "optional": {},
        "effectiveness": 0.55,
    },
    "wordlist_delete": {
        "desc": "Delete a specific wordlist entry by its ID.",
        "endpoint": "/api/wordlists/<wordlist_id>",
        "method": "DELETE",
        "category": "brute_force",
        "params": {"wordlist_id": {"required": True}},
    ...
    "monitor_cve_feeds": {
        ...
        "category": "vulnerability_intelligence",
        "params": {},
        "optional": {"hours": 24, "severity_filter": "HIGH,CRITICAL", "keywords": ""},
        "effectiveness": 0.80,
    },
    "generate_exploit_from_cve": {
        "desc": "Generate working exploits from CVE information using AI-powered analysis.",
        "endpoint": "/api/vuln-intel/exploit-generate",
        "method": "POST",
        "category": "vulnerability_intelligence",
        "params": {"cve_id": {"required": True}},
        "optional": {"target_os": "", "target_arch": "x64", "exploit_type": "poc", "evasion_level": "none"},
        "effectiveness": 0.75,
    },
    "discover_attack_chains": {
        "desc": "Discover multi-stage attack chains for target software with vulnerability correlation.",
        "endpoint": "/api/vuln-intel/attack-chains",
        "method": "POST",
        "category": "vulnerability_intelligence",
        "params": {"target_software": {"required": True}},
        "optional": {"attack_depth": 3, "include_zero_days": False},
        "effectiveness": 0.75,
    },
    "research_zero_day_opportunities": {
        "desc": "Automated zero-day vulnerability research using AI analysis and pattern recognition.",
        "endpoint": "/api/vuln-intel/zero-day-research",
        "method": "POST",
        "category": "vulnerability_intelligence",
        "params": {"target_software": {"required": True}},
        "optional": {"analysis_depth": "standard", "source_code_url": ""},
        "effectiveness": 0.65,
    },
    "correlate_threat_intelligence": {
        "desc": "Correlate threat intelligence across multiple sources with advanced analysis.",
        "endpoint": "/api/vuln-intel/threat-feeds",
        "method": "POST",
        "category": "vulnerability_intelligence",
        "params": {"indicators": {"required": True}},
        "optional": {"timeframe": "30d", "sources": "all"},
        "effectiveness": 0.70,
    },
    "advanced_payload_generation": {
        "desc": "Generate advanced payloads with AI-powered evasion techniques and contextual adaptation.",
        "endpoint": "/api/ai/advanced-payload-generation",
        "method": "POST",
        "category": "vulnerability_intelligence",
        "params": {"attack_type": {"required": True}},
        "optional": {"target_context": "", "evasion_level": "standard", "custom_constraints": ""},
        "effectiveness": 0.80,
    },

    # ---- Monitoring & Process Management ----
    "server_health": {
        "desc": "Check the health status of the API server, including tool availability and telemetry.",
        "endpoint": "/health",
        "method": "GET",
        "category": "essential",
        "params": {},
    ...
    "get_cache_stats": {
        "desc": "Get cache statistics from the API server.",
    ...
    "clear_cache": {
        "desc": "Clear the cache on the API server.",
    ...
    "get_telemetry": {
        "desc": "Get system telemetry from the API server.",
    ...
    "list_active_processes": {
        "desc": "List all active processes on the API server.",
    ...
    "get_process_status": {
        "desc": "Get the status of a specific process.",
    ...
    "terminate_process": {
        "desc": "Terminate a specific running process.",
    ...
    "pause_process": {
        "desc": "Pause a specific running process.",
    ...
    "get_process_dashboard": {
        "desc": "Get enhanced process dashboard with visual status indicators.",
    ...
    # ---- AI Payload Testing & LLM Agent ----
    "ai_test_payload": {
        "desc": "Test generated payload against target with AI analysis.",
        "endpoint": "/api/ai/test_payload",
        "method": "POST",
        "category": "exploitation",
        "params": {"payload": {"required": True}, "target_url": {"required": True}},
        "optional": {"method": "GET"},
        "effectiveness": 0.65,
    },
    "llm_agent_scan_result": {
        "desc": "Retrieve the results of a completed LLM agent scan session.",
    ...
    "llm_status": {
        "desc": "Check whether the LLM backend is available and report its configuration.",
    ...
    "format_tool_output_visual": {
        "desc": "Format tool output with beautiful visual styling, syntax highlighting, and structure.",
        "endpoint": "/api/visual/tool-output",
        "method": "POST",
        "category": "essential",
        "params": {"tool_name": {"required": True}, "output": {"required": True}},
        "optional": {"success": True},
        "effectiveness": 0.50,
    },
    "create_scan_summary": {
        "desc": "Create a comprehensive scan summary report with beautiful visual formatting.",
        "endpoint": "/api/visual/summary-report",
        "method": "POST",
        "category": "essential",
        "params": {"target": {"required": True}, "tools_used": {"required": True}},
        "optional": {"vulnerabilities_found": 0, "execution_time": 0.0, "findings": ""},
        "effectiveness": 0.50,
    },

    # ---- Bug Bounty Workflows ----
    "bugbounty_reconnaissance_workflow": {
        "desc": "Create comprehensive reconnaissance workflow for bug bounty hunting.",
        "endpoint": "/api/bugbounty/reconnaissance-workflow",
        "method": "POST",
        "category": "web_vuln",
        "params": {"domain": {"required": True}},
        "optional": {"scope": "", "out_of_scope": "", "program_type": "web"},
        "effectiveness": 0.80,
    },
    "bugbounty_vulnerability_hunting": {
        "desc": "Create vulnerability hunting workflow prioritized by impact and bounty potential.",
        "endpoint": "/api/bugbounty/vulnerability-hunting-workflow",
        "method": "POST",
        "category": "web_vuln",
        "params": {"domain": {"required": True}},
        "optional": {"priority_vulns": "rce,sqli,xss,idor,ssrf", "bounty_range": "unknown"},
        "effectiveness": 0.80,
    },
    "bugbounty_business_logic_testing": {
        "desc": "Create business logic testing workflow for advanced bug bounty hunting.",
        "endpoint": "/api/bugbounty/business-logic-workflow",
        "method": "POST",
        "category": "web_vuln",
        "params": {"domain": {"required": True}},
        "optional": {"program_type": "web"},
        "effectiveness": 0.70,
    },
    "bugbounty_osint_gathering": {
        "desc": "Create OSINT gathering workflow for bug bounty reconnaissance.",
    ...
    "bugbounty_file_upload_testing": {
        "desc": "Create file upload vulnerability testing workflow with bypass techniques.",
        "endpoint": "/api/bugbounty/file-upload-testing",
        "method": "POST",
        "category": "web_vuln",
        "params": {"target_url": {"required": True}},
        "optional": {},
        "effectiveness": 0.70,
    },
    ...
    "waymore": {
        ...
        "optional": {
            "mode": "U", "output_urls": "", "output_responses": "",
            "limit": "", "timeout": "", "verbose": False, "no_subs": False,
        },
        "effectiveness": 0.85,
    },
  ...
  # ---- Intelligence ----
    ...
    "masscan": {
        ...
        "category": "network_recon",
        "params": {"target": {"required": True}},
        "optional": {"ports": "1-65535", "rate": "1000", "interface": "", "router_mac": "", "source_ip": "", "banners": False, "additional_args": ""},
        "effectiveness": 0.92,
    },
    "rustscan": {
        ...
        "category": "network_recon",
        "params": {"target": {"required": True}},
        "optional": {"ports": "", "ulimit": 5000, "batch_size": 4500, "timeout": 1500, "scripts": False, "additional_args": ""},
        "effectiveness": 0.90,
    },
    "enum4linux": {
    ...
    "smbmap": {
        ...
        "category": "network_recon",
        "params": {"target": {"required": True}},
        "optional": {"username": "", "password": "", "domain": "", "additional_args": ""},
        "effectiveness": 0.85,
    },
    "netexec": {
        "desc": "Network service exploitation and enumeration (formerly CrackMapExec)",
    ...
    "arp-scan": {
        ...
        "category": "network_recon",
        "params": {},
        "optional": {"target": "", "interface": "", "local_network": False, "timeout": 500, "retry": 3, "additional_args": ""},
        "effectiveness": 0.85,
    },
    ...
    # ---- web_interaction (Jev, HTTP-backed vs JEV_URL) — T-6 ----
    "web_run_goal": {
        "desc": "Drive Jev to complete a web subgoal end-to-end (loop until DONE/BLOCKED/budget)",
        "endpoint": "/api/tools/web_run_goal",
        "method": "POST",
        "category": "web_interaction",
        "params": {"url": {"required": True}, "goal": {"required": True}, "session_id": {"required": True}},
        "optional": {"max_actions": 40, "max_decisions": 80, "reuse_session": True, "scope_allowlist": [], "verify": "", "screenshots": False},
        "effectiveness": 0.80,
    },
    "web_extract_surface": {
        "desc": "Cheap web recon: one indexed DOM/ARIA snapshot of a URL (no action loop)",
        "endpoint": "/api/tools/web_extract_surface",
        "method": "POST",
        "category": "web_interaction",
        "params": {"url": {"required": True}, "session_id": {"required": True}},
        "optional": {"reuse_session": True},
        "effectiveness": 0.78,
    },
    "web_get_evidence": {
        "desc": "Retrieve the full evidence (trace, snapshot, evidence-chain hash) for a Jev run",
        "endpoint": "/api/tools/web_get_evidence",
        "method": "GET",
        "category": "web_interaction",
        "params": {"run_id": {"required": True}},
        "optional": {},
        "effectiveness": 0.75,
    },
    "hurl": {
    ...
    "dalfox": {
        ...
        "category": "web_recon",
        "params": {},
        "optional": {"url": "", "pipe_mode": False, "blind": False, "mining_dom": True, "mining_dict": True, "custom_payload": "", "additional_args": ""},
        "effectiveness": 0.93,
    },
    "xsser": {
    ...
    "jaeles": {
        ...
        "category": "web_recon",
        "params": {"url": {"required": True}},
        "optional": {"signatures": "", "config": "", "threads": 20, "timeout": 20, "additional_args": ""},
        "effectiveness": 0.92,
    },
    ...
    "msfvenom": {
        ...
        "optional": {"format": "elf", "output_file": "", "encoder": "", "iterations": "", "additional_args": ""},
        "effectiveness": 0.85,
    },
    # ---- Brute Force ----
    "hydra": {
    ...
    "strings": {
        ...
        "category": "forensics",
        "params": {"file_path": {"required": True}},
        "optional": {"min_len": 4, "additional_args": ""},
        "effectiveness": 0.70,
    },
    "ropgadget": {
        ...
        "category": "binary",
        "params": {"binary": {"required": True}},
        "optional": {"gadget_type": "", "additional_args": ""},
        "effectiveness": 0.82,
    },
    "radare2": {
    ...
    "pacu" : {
        ...
        "category": "cloud",
        "params": {},
        "optional": {"session_name": "session_default", "modules": "", "data_services": "", "regions": "", "additional_args": ""},
        "effectiveness": 0.90,
    },
    "cloudmapper" : {
    ...
    "trivy": {
        ...
        "category": "cloud",
        "params": {"target": {"required": True}},
        "optional": {"scan_type": "image", "output_format": "json", "severity": "", "output_file": "", "additional_args": ""},
        "effectiveness": 0.88,
    },
    "kube-hunter": {
    ...
    "libc-database": {
        ...
        "category": "binary",
        "params": {},
        "optional": {"action": "find", "symbols": "", "libc_id": "", "additional_args": ""},
        "effectiveness": 0.80,
    },
    "xxd": {
    ...
    "pwntools": {
        ...
        "category": "binary",
        "params": {},
        "optional": {"script_content": "", "target_binary": "", "target_host": "", "target_port": 0, "exploit_type": "local", "additional_args": ""},
        "effectiveness": 0.88,
    },
    "pwninit": {
    ...
    "exploit_db": {
        "desc": "Search the local exploit database (SearchSploit) for known exploits",
    ...
    "metasploit": {
        "desc": "Run a Metasploit module against a target",
    ...
    "mysql": {
        ...
        "method": "POST",
        "category": "database",
        "params": {"host": {"required": True}, "user": {"required": True}},
        "optional": {"password": "", "database": "", "query": ""},
        "effectiveness": 0.90,
    },
    "sqlite3": {
